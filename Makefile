...
pkgdatadir = $(datadir)/image-recognition
pkgincludedir = $(includedir)/image-recognition
pkglibdir = $(libdir)/image-recognition
pkglibexecdir = $(libexecdir)/image-recognition
...
am__aclocal_m4_deps = $(top_srcdir)/m4/pygobj-3.m4 \
...
PACKAGE_NAME = Image Recognition
PACKAGE_STRING = Image Recognition 1.0
PACKAGE_TARNAME = image-recognition
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/image-recognition
pkgpythondir = ${pythondir}/image-recognition
prefix = /usr/local
